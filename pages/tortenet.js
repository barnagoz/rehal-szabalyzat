...
import ATabla from '../public/ATabla.jpeg'
  ...
  return (
      <>
        ...
        <div className="w-full flex flex-col justify-start items-center">
            ...
            <br></br>
            <Image className="rounded-md" alt="A tábla tele halakkal" src={ATabla}></Image>
            <br></br>
            <p>
            ...
            <br/>
            <p>
              Szóval így alakult meg a ReHal. És neked mi a történeted? Hogy találtál ide? Írj nekünk a <a className="underline decoration-dashed hover:decoration-dotted cursor-pointer" href="mailto:hali@rehal.ga">hali@rehal.ga</a> címre!
            </p>
            <br></br>
